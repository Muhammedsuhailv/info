...
class Sessionall extends StatefulWidget {
  const Sessionall({Key? key}) : super(key: key);

  @override
  State<Sessionall> createState() => _SessionallState();
}

class _SessionallState extends State<Sessionall> {
  @override
                    ...
                    children: [
                      Column(children: [
                        ...
                        Padding(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("14-03-2023 ",style: TextStyle(fontWeight: FontWeight.w400,color: Colors.white,fontSize: 20),),
                    ...
                    children: [
                      Column(children: [
                        ...
                        Padding(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("11-03-2023 ",style: TextStyle(fontWeight: FontWeight.w400,color: Colors.white,fontSize: 20),),
                        ...
                        InkWell(onTap: (){ Navigator.push(context, MaterialPageRoute(builder: (context)=>sessions()));},
                          child: Padding(
                            ...
                            child: Container(alignment: Alignment.center,
                                height: 40,width: 140,
                                decoration: BoxDecoration(gradient: LinearGradient(begin: Alignment.topLeft,end:Alignment.bottomCenter,colors: [HexColor("2FAF2C"),HexColor("188E15")]), color: Colors.white.withOpacity(0.5),borderRadius: BorderRadius.circular(10)),
                                child: Text("Finished Session",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),)),
                          ),
                        ),
                    ...
                    children: [
                      Column(children: [
                        ...
                        Padding(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("10-03-2023 ",style: TextStyle(fontWeight: FontWeight.w400,color: Colors.white,fontSize: 20),),
